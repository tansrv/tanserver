...
YY_BUFFER_STATE cfg_yy_scan_bytes (yyconst char *bytes,yy_size_t len  );
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE cfg_yy_scan_bytes  (yyconst char * yybytes, yy_size_t  _yybytes_len )
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
